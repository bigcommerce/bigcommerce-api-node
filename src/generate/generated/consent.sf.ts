...
export interface operations {
  ...
  postConsent: {
    ...
    /** Data sent to the [Update Customer Consent](/api-reference/store-management/customers-v3/customer-consent/customersconsentbycustomerid-put) Customers V3 endpoint when creating a customer during checkout */
    requestBody: {
      content: {
