...
export interface components {
  schemas: {
    ...
    'request-item-wrapping': {
       ...
       */
      type: 'item' | 'wrapping' | 'handling' | 'shipping' | 'refund';
      wrapping?: Partial<components['schemas']['request-item']> & Partial<unknown>;
    };
    /**
     * DocumentRequest
    ...
    'request-document': {
      ...
      items: components['schemas']['request-item-wrapping'][];
    };
    /**
     * QuoteRequest
    ...
    'response-document': {
      ...
      items: components['schemas']['response-item-wrapping'][];
    ...
    /**
     * ItemWrapping
     * @description The tax liabilities calculated for a specific item, including the liabilities for wrapping tax.
     *
     * Note: Tax liabilities should be calculated with **quantity** accounted for.
     */
